package org.Kyoee01.PixelmonServer;
...
import org.Kyoee01.PixelmonServer.listeners.ForgeEventListener;
...
@Mod("pixelmonserver")
public class PixelmonServer {

    // Directly reference a log4j logger.
    private static final Logger LOGGER = LogManager.getLogger();

    public PixelmonServer() {
        FMLJavaModLoadingContext.get().getModEventBus().addListener(PixelmonServer::init);
        FMLJavaModLoadingContext.get().getModEventBus().addListener(PixelmonServer::postInit);
